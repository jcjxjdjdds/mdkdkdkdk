...
import os
token = '5263113264:AAG10fBRoKE-w2rZbBLNoUhy8R48XxbP6oQ'
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber ='2095495680'
@bot.message_handler(commands=["start"])
def start(message):
	if not str(message.chat.id) == subscriber:
		bot.reply_to(message, "You cannot use the bot to contact developers to purchase a bot subscription @F_X_X2")
		return
